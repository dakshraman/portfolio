    ...
    >
      ...
      <div
        ...
        style={{
          ...
          borderRadius: hubOpen ? '28px' : '9999px',
          boxShadow: hubOpen
          ...
          maxWidth: hubOpen
            ...
            : isCompact
              ? 'min(360px, 92vw)'
              : 'min(780px, 96vw)',
          transition: 'max-width 0.45s cubic-bezier(0.32, 0.72, 0, 1), border-radius 0.4s cubic-bezier(0.32, 0.72, 0, 1), background 0.3s ease, box-shadow 0.4s ease',
          overflow: 'hidden',
          display: 'flex',
