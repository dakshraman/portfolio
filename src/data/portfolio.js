...
export const blogs = [
  ...
  {
    slug: 'server-side-events-vs-websockets-laravel-reverb',
    title: 'Server-Sent Events (SSE) vs WebSockets: Real-Time with Laravel Reverb',
    excerpt: 'When to use Server-Sent Events over WebSockets. A practical guide to implementing lightweight real-time updates using Laravel Reverb without the overhead of two-way communication.',
    date: '2026-09-18',
    readTime: '7 min read',
    tags: ['Laravel', 'Reverb', 'WebSockets', 'SSE'],
    featured: false,
  },
  {
    slug: 'top-searched-it-topics',
    title: 'Top Searched IT Topics in 2026: What Developers Need to Learn',
    excerpt: 'From Agentic AI coding assistants and WebAssembly to Server-Driven UI and edge computing. Here are the most searched and highly demanded topics in IT right now.',
    date: '2026-09-15',
    readTime: '6 min read',
    tags: ['Tech Trends', 'AI', 'Career'],
    featured: false,
  },
  {
